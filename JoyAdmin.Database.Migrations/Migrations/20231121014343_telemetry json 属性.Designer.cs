...
namespace JoyAdmin.Database.Migrations.Migrations
{
    ...
    [Migration("20231121014343_telemetry json 属性")]
    partial class telemetryjson属性
    {
            ...
            modelBuilder.Entity("JoyAdmin.Core.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 11, 21, 9, 43, 42, 868, DateTimeKind.Local).AddTicks(8599),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Name = "管理员",
            ...
            modelBuilder.Entity("JoyAdmin.Core.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 11, 21, 9, 43, 42, 868, DateTimeKind.Local).AddTicks(9976),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 2L,
                            CreatedTime = new DateTime(2023, 11, 21, 9, 43, 42, 868, DateTimeKind.Local).AddTicks(9980),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 3L,
                            CreatedTime = new DateTime(2023, 11, 21, 9, 43, 42, 868, DateTimeKind.Local).AddTicks(9981),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
            ...
            modelBuilder.Entity("JoyAdmin.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Account = "admin",
                            CreatedTime = new DateTime(2023, 11, 21, 9, 43, 42, 869, DateTimeKind.Local).AddTicks(5561),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
