...
namespace JoyAdmin.Database.Migrations.Migrations
{
    ...
    [Migration("20240125153757_update-database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoyAdmin.Core.Entities.Custom.BaseProcessLineList", b =>
                {
                    ...
                    b.ToTable("BaseProcessLineList", (string)null);
                });
            ...
            modelBuilder.Entity("JoyAdmin.Core.Entities.Production.Production_ProcessRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Production_ProcessRecord", (string)null);
                });

            modelBuilder.Entity("JoyAdmin.Core.Entities.Production.Production_ProductRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Production_ProductRecord", (string)null);
                });
            ...
            modelBuilder.Entity("JoyAdmin.Core.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2024, 1, 25, 23, 37, 56, 812, DateTimeKind.Local).AddTicks(1230),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Name = "管理员",
            ...
            modelBuilder.Entity("JoyAdmin.Core.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2024, 1, 25, 23, 37, 56, 812, DateTimeKind.Local).AddTicks(4040),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 2L,
                            CreatedTime = new DateTime(2024, 1, 25, 23, 37, 56, 812, DateTimeKind.Local).AddTicks(4050),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
            ...
            modelBuilder.Entity("JoyAdmin.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Account = "admin",
                            CreatedTime = new DateTime(2024, 1, 25, 23, 37, 56, 813, DateTimeKind.Local).AddTicks(720),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
            ...
            modelBuilder.Entity("JoyAdmin.Core.Entities.Custom.BaseProcessLineList", b =>
                {
                    b.HasOne("JoyAdmin.Core.Entities.Custom.Base_ProcessLine", "ProcessLineDown")
                        .WithMany()
                        .HasForeignKey("ProcessLineDown_Id");
            ...
            modelBuilder.Entity("JoyAdmin.Core.Entities.Production.Production_ProcessRecord", b =>
                {
                    ...
                    b.HasOne("JoyAdmin.Core.Entities.Production.Production_ProductRecord", "ProductRecord")
            ...
            modelBuilder.Entity("JoyAdmin.Core.Entities.Production.Production_ProductRecord", b =>
                {
                    b.HasOne("JoyAdmin.Core.Entities.Custom.Base_Process", "CurrentProcess")
                        .WithMany()
                        .HasForeignKey("CurrentProcessId");

                    b.HasOne("JoyAdmin.Core.Entities.Custom.Base_Product", "Product")
                        .WithMany()
