...
namespace JoyAdmin.Database.Migrations.Migrations
{
    ...
    [Migration("20230403083705_添加设备统计信息")]
    partial class 添加设备统计信息
    {
            ...
            modelBuilder.Entity("JoyAdmin.Core.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 4, 3, 16, 37, 5, 168, DateTimeKind.Local).AddTicks(1313),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Name = "管理员",
            ...
            modelBuilder.Entity("JoyAdmin.Core.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 4, 3, 16, 37, 5, 168, DateTimeKind.Local).AddTicks(3944),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 2L,
                            CreatedTime = new DateTime(2023, 4, 3, 16, 37, 5, 168, DateTimeKind.Local).AddTicks(3950),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 3L,
                            CreatedTime = new DateTime(2023, 4, 3, 16, 37, 5, 168, DateTimeKind.Local).AddTicks(3953),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
            ...
            modelBuilder.Entity("JoyAdmin.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Account = "admin",
                            CreatedTime = new DateTime(2023, 4, 3, 16, 37, 5, 169, DateTimeKind.Local).AddTicks(4454),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
