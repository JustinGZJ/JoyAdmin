...
namespace JoyAdmin.Database.Migrations.Migrations
{
    ...
    [Migration("20230324001504_addindex")]
            ...
            modelBuilder.Entity("JoyAdmin.Core.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 3, 24, 8, 15, 3, 981, DateTimeKind.Local).AddTicks(201),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Name = "管理员",
            ...
            modelBuilder.Entity("JoyAdmin.Core.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 3, 24, 8, 15, 3, 981, DateTimeKind.Local).AddTicks(1865),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 2L,
                            CreatedTime = new DateTime(2023, 3, 24, 8, 15, 3, 981, DateTimeKind.Local).AddTicks(1869),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 3L,
                            CreatedTime = new DateTime(2023, 3, 24, 8, 15, 3, 981, DateTimeKind.Local).AddTicks(1870),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
            ...
            modelBuilder.Entity("JoyAdmin.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Account = "admin",
                            CreatedTime = new DateTime(2023, 3, 24, 8, 15, 3, 981, DateTimeKind.Local).AddTicks(7842),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
