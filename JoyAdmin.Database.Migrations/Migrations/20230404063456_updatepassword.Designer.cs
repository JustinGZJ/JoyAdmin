...
namespace JoyAdmin.Database.Migrations.Migrations
{
    ...
    [Migration("20230404063456_updatepassword")]
            ...
            modelBuilder.Entity("JoyAdmin.Core.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 4, 4, 14, 34, 56, 151, DateTimeKind.Local).AddTicks(2745),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Name = "管理员",
            ...
            modelBuilder.Entity("JoyAdmin.Core.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 4, 4, 14, 34, 56, 151, DateTimeKind.Local).AddTicks(4815),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 2L,
                            CreatedTime = new DateTime(2023, 4, 4, 14, 34, 56, 151, DateTimeKind.Local).AddTicks(4819),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 3L,
                            CreatedTime = new DateTime(2023, 4, 4, 14, 34, 56, 151, DateTimeKind.Local).AddTicks(4821),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
            ...
            modelBuilder.Entity("JoyAdmin.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Account = "admin",
                            CreatedTime = new DateTime(2023, 4, 4, 14, 34, 56, 152, DateTimeKind.Local).AddTicks(5260),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
