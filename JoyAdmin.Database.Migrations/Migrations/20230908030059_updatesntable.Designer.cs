...
namespace JoyAdmin.Database.Migrations.Migrations
{
    ...
    [Migration("20230908030059_updatesntable")]
    partial class updatesntable
    {
            ...
            modelBuilder.Entity("JoyAdmin.Core.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 9, 8, 11, 0, 58, 732, DateTimeKind.Local).AddTicks(7307),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Name = "管理员",
            ...
            modelBuilder.Entity("JoyAdmin.Core.Security", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTime = new DateTime(2023, 9, 8, 11, 0, 58, 732, DateTimeKind.Local).AddTicks(8765),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 2L,
                            CreatedTime = new DateTime(2023, 9, 8, 11, 0, 58, 732, DateTimeKind.Local).AddTicks(8770),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
                        ...
                        {
                            Id = 3L,
                            CreatedTime = new DateTime(2023, 9, 8, 11, 0, 58, 732, DateTimeKind.Local).AddTicks(8772),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
                            Sort = 0,
            ...
            modelBuilder.Entity("JoyAdmin.Core.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Account = "admin",
                            CreatedTime = new DateTime(2023, 9, 8, 11, 0, 58, 733, DateTimeKind.Local).AddTicks(4906),
                            CreatedUserId = 0L,
                            IsDeleted = false,
                            ModifiedUserId = 0L,
