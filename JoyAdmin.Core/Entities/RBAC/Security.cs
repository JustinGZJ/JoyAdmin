...
public class Security : BaseEntity, IEntitySeedData<Security>
{
    ...
    public IEnumerable<Security> HasData(DbContext dbContext, Type dbContextLocator)
    {
        ...
        {
            new() { Id = 1, CreatedTime = DateTime.Now, UniqueCode = "role", UniqueName = "角色管理" },
            new() { Id = 2, CreatedTime = DateTime.Now, UniqueCode = "auth", UniqueName = "权限管理" },
            new() { Id = 3, CreatedTime = DateTime.Now, UniqueCode = "employee", UniqueName = "员工管理" }
        };
